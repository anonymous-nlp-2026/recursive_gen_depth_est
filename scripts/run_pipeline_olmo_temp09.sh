#!/bin/bash
# 递归生成链流水线 (OLMo-1B, temperature=0.9, no top_p/top_k)
...
GPU=${GPU:-0}
DATA_DIR="data/olmo_temp09"
CKPT_DIR="checkpoints/olmo_temp09"
LOG_FILE="logs/pipeline_olmo_temp09.log"
...
echo "=== OLMo-1B temp_only Pipeline complete! ==="
