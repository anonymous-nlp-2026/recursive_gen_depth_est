#!/bin/bash
# 递归生成链流水线 (GPT-2 XL 1.5B, temperature=0.9, no top_p/top_k)
...
GPU=${GPU:-0}
DATA_DIR="data/gpt2xl_temp09"
CKPT_DIR="checkpoints/gpt2xl_temp09"
...
echo "=== Pipeline: GPT-2 XL temp_only t=0.9 ==="
...
echo "=== GPT-2 XL temp_only Pipeline complete! ==="
