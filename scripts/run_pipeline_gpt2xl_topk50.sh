#!/bin/bash
# 递归生成链流水线 (GPT-2 XL 1.5B, top_k=50)
...
GPU=${GPU:-0}
DATA_DIR="data/gpt2xl_topk50"
CKPT_DIR="checkpoints/gpt2xl_topk50"
LOG_FILE="logs/pipeline_gpt2xl_topk50.log"
...
echo "=== Pipeline: GPT-2 XL topk k=50 ==="
...
echo "=== GPT-2 XL topk Pipeline complete! ==="
