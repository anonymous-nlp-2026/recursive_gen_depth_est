#!/bin/bash
# 递归生成链流水线 (Pythia-1.4B, temperature=0.9, no top_p/top_k)
...
GPU=${GPU:-0}
DATA_DIR="data/pythia_temp09"
CKPT_DIR="checkpoints/pythia_temp09"
...
echo "=== Pipeline: Pythia-1.4B temp_only t=0.9 ==="
